...
1.  What type of study do you think these data come from: observational or experiment?
    Why?
    ***This was an observational study, there was no assigned treatment group for people.***

2.  How many observations are in this dataset?
    What does each observation represent?
    ***There are `r nrow(Whickham)` observations in this data set. Each observation represents one particular women in the study.***
...
3.  How many variables are in this dataset?
    ...
    ***There are `r ncol(Whickham)` variables in this data set. Both `outcome` and `smoker` are character data that are 2 level factors and `age` is numerical data.***
...
```
***This does not meet what I thought would happen. It appears that those that do smoke have a higher probability of being alive 20 years later.***
